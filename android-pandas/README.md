...
[![Version](https://img.shields.io/badge/Version-0.0.1.rc3-blue.svg)](CHANGELOG.md)
...
**当前版本**: `0.0.1.rc3` (2025-12-19)  
**更新内容**: [查看更新日志](CHANGELOG.md)  
**主要变更**: DataFrame API 统一化，返回类型改为 `Map<String, Series<Any>?>`
